  ...
  if (am==0)
  {
    ...
    PARDISO (pt, &maxfct, &mnum, &mtype, &phase,
      ...
      PARDISO (pt, &maxfct, &mnum, &mtype, &phase,
        ...
        {
          /* Counters */
          long int m1,m2,m3,m4,un2[100];
          /* Val Buffer */
          double ival,ival1,ui2[100],koef;
          /**/
          /**/
...
//printf("%i %i %e\n",m2,un1[m2],ui1[m2]);
          ...
          for (m1=1;m1<=un1[0];m1++)
          {
          m3=1000000000;m4=0;koef = 0;
          for (m2=1;m2<=un1[0];m2++)
          {
	  if(un2[m2]<m3) {m3=un2[m2]; m4=m2; koef = ui2[m2];}
	  }
          un1[m1] = m3;
	  ui1[m1] = koef;
          un2[m4]=100000000000;
//printf("%i %i %e\n",m1,un1[m1],ui1[m1]);
          ...
          for (m2=1;m2<=un1[0];m2++)
          {
           ...
           fl = fopen("coef_MG_finest.txt","a");
           for (m2=1;m2<=un1[0];m2++)
           {
               fprintf(fl,"%e %i \n",ui1[m2],un1[m2]-mgp[multinum]*4);
           }
           fclose(fl);
          /*
