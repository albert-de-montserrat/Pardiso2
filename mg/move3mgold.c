...
{
  /* Counters */
  long int m2prn=0,m1prn=0,m1,m2,m3,m4,m5,m10,m20,m30,m40,mcmax,mcmax0,mcmax1,nnodes;
    ...
    do
    {
      ...
      for(n1=0;n1<multicyc;n1++)
      {
        ...
        if(multinum>0)
        {
          ...
          fl = fopen("sol0_gaus_precoarsest.txt","w");
          // for (m1=mgp[mgi]*4;m1<(mgp[mgi]+mgn[mgi])*4;m1++)
