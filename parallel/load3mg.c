...
#pragma omp parallel
    ...
    if(mode==1)
    {
        ...
        bufvs = malloc(sizeof(double) * mgn[multinum]*4 );
        curs  = malloc(sizeof(int) * mgn[multinum]*4 );
        ...
        bufvp = malloc(sizeof(double *) * nt );
        curp  = malloc(sizeof(int *) * nt );
        for(i=0;i<nt;i++)
        {
            ...
            bufvp[i]= malloc(sizeof(double) * mgn[multinum]*4 );
            curp[i] = malloc(sizeof(int) * mgn[multinum]*4 );
        }
