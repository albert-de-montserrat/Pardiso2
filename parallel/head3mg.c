...
#endif
/* Main Sizes */
#define MAXMAT 1000000000 /* General Matrix Size */
#define MAXXLN   2001 /* Max Node num for Grid in X-direction */
#define MAXYLN   2001 /* Max Node num for Grid in Y-direction */
#define MAXZLN   2001 /* Max Node num for Grid in Z-direction */
#define MAXTMR    200 /* Max markers types */
#define MAXPOS   2000 /* Max Pos on Line num for wi[], wn[] buffers */
#define MAXFLN   1500 /* Max Output file names Num */
#define MAXNOD 2000000000 /* Max Total nodes num for all grids */
#define MAXNNN 2000000000 /* Max Total nodes num for finest grid */
#define MAXPAR 200000000  /* Max Total par num for all grids */
#define MAXPPP 200000000  /* Max vx,vy,vz,p par num for all grids */
#define MAXMRK 200000000  /* Max total marker Num */
#define MAXBON  20000000  /* Max Total bondary condition Equations */
#define MRKNEW      1.0   /* Multiplying factor:if new markers are generated by dehydration/melting MRKNEW > 1 or with permeable boundary*/
/* End MACROS --------------------------------------------- */
...
long int memtot[2];
/*
long int connectivity[MAXNNN][8],mu[10][7];
float vertices[MAXNNN][3];
*/
int Mu,xperiodic,yperiodic,zperiodic,drexmod;
double mucnst[10],yieldstress;
/* ARRAYS --------------------------------------------- */
...
double Sol0[MAXCPU][MAXPPP],Sol1[MAXCPU][MAXPPP];
...
/*
*/
double *val1,*fre1,*fre0,*bufv,*bufv0,*bufvs;
double *sol0,*sol1;
int *lin0,*num0,*cur0,*curs;
int *pos0,*bufn;
int **curp;
double **Sol0,**Sol1,**bufvp;
...
char sa[500];
char fl1in[60],fl1in1[600],fl1out[60],outdir[500],outdir0[500];
int fl1itp,fl1otp;
...
int printmod,fl0num,markmod,movemod,densimod,filesjob,effbulkviscmod;
double gridcur,gridtot,stp100,platesdistance;
/**/
/**/
/**/
...
void movemark();
void ronurecalc();
double viscalc(double, double, long int, int, float *);
